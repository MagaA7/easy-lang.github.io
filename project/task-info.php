    ...
    onClose: function(selectedDates, dateStr, instance) {
      ...
      if (endDatePicker) {
        ...
        if (selectedDates[0] !== null && selectedDates[0] >= endDatePicker.selectedDates[0]) {
          endDatePicker.setDate(selectedDates[0].getTime() + 30*60 * 1000); // Set end time to be 1 minute after start time
        }
      }
    }
  });
    ...
    onClose: function(selectedDates, dateStr, instance) {
      ...
      if (startDatePicker) {
        ...
        if (selectedDates[0] !== null && selectedDates[0] <= startDatePicker.selectedDates[0]) {
          startDatePicker.setDate(selectedDates[0].getTime() - 30*60 * 1000); // Set start time to be 1 minute before end time
        }
      }
    }
  });
